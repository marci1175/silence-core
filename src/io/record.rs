...
use cpal::{traits::{DeviceTrait, StreamTrait}, StreamConfig, StreamError};
...
{
    let buffer_handle: Arc<parking_lot::lock_api::Mutex<parking_lot::RawMutex, Vec<f32>>> = Arc::new(parking_lot::Mutex::new(Vec::new()));
